...
const QString BITCOIN_IPC_PREFIX("ufohub:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ufohub-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ufohub-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ufohub-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click ufohub: links
...
//
// OSX-specific way of handling ufohub: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ufohub: URIs
