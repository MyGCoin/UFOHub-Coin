...
These are the dependencies currently used by UFOHub. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/ufohubnl
Keybase  - https://keybase.io/team/ufohub/
