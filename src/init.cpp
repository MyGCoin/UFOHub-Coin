 ...
 * between ufohubd, and ufohub-qt and non-server tools.
*/
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://www.ufohub.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The UFOHub Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find UFOHub useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("UFOHub More version %s\n", FormatFullVersion());
}
