...
#if defined(NDEBUG)
# error "UFOHub cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "UFOHub Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // UFOHub also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // UFOHub also requires low S in sigs
