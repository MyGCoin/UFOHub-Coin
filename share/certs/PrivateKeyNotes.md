...
unlocked to sign the UFOHub-Qt.app bundle.
...
allowing somebody to distribute a UFOHub-Qt.app or ufohub-qt-setup.exe with a valid
...
that the ufohub-qt.exe file inside the installer had not been tampered with.
